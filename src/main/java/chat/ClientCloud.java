...
public class ClientCloud {
    ...
    private static final String account = "Cloud";

    private static final String my_host = "127.0.0.1";

    private static final int my_port = 9100;
    ...
    public static void main(String[] args) throws IOException {
        ...
        new Thread(() -> {
            for (; ; ) {
                ...
                MyMessage message = new MyMessage(UUID.randomUUID().toString(), content, account, "May");
                try {
